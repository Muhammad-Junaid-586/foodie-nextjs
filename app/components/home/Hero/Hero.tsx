    ...
    <div className='relative w-full h-screen flex justify-center flex-col'>
      <div className="w-[90%] md:w-[80%] mx-auto grid items-center grid-cols-1 xl:grid-cols-2 gap-10 ">
        ...
        <div data-aos="fade-up">
          <h1 className='text-3xl md:text-4xl lg:text-5xl mt-6 mb-6 font-extrabold leading-[2.5rem] md:leading-[4rem] '>Your favorite food, <span className='text-pink-500'>delivered</span> your home</h1>

          {/* subheading */}
          <p className='text-sm md:text-base font-medium text-gray-800 dark:text-gray-400 '>Food, drinks, groceries, and more available for delivery and pickup.</p>

          {/* address input */}
          <div className='w-full mt-8 mb-8  max-w-md'>
            <div className="flex items-center overflow-hidden shadow-md h-14 bg-gray-100">
          ...
          <FaApple className='text-2xl mr-2 group-hover:text-white transiton-all duration-300'/>
          <div>
          ...
          {/* play store button */}
           <div className='flex space-x-4'>
            <a href="#_" className='flex items-center group border border-gray-400 px-4 py-3 rounded-md hover:bg-gray-950 transition-all duration-300'>
          <FaGooglePlay className='text-2xl mr-2 group-hover:text-white transiton-all duration-300'/>
          <div>
            <p className='text-xs group-hover:text-white transition-all duration-300'>Download on the</p>
