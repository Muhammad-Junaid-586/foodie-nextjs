...
const RestaurentCard = ({image,title}:Props) => {
  return (
    <div>
      ...
      <div className='flex item-center font-medium mt-3 space-x-2'>
        <p className='bg-blue-950 px-3 py-[1.5] rounded-full text-sm sm:text-base text-white '>American</p>
        <p className='bg-blue-950 px-3 py-[1.5] rounded-full text-sm sm:text-base text-white '>Fast Foods</p>
